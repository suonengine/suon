...
/// [`crate::ScriptRegistry`] on first insert. Manual implementations must provide
/// equivalent registration behavior or explicitly call [`AppLuaExt::register_lua_component`].
