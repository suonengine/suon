...
///         use suon_protocol::prelude::*;
///
///         let mut decoder: &mut &[u8] = bytes;
///         let username = decoder.get_str()?;
///         Ok(LoginPacket { username: username.to_owned() })
///     }
/// }
///
...
/// ```
///
/// This trait is typically paired with the server-side `Encodable` trait from
/// `suon_protocol_server::prelude` to allow symmetric serialization and
/// deserialization of packet types.
