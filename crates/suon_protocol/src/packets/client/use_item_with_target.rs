...
pub struct UseItemWithTargetPacket {
...
impl Decodable for UseItemWithTargetPacket {
    const KIND: PacketKind = PacketKind::UseItemWithTarget;
...
mod tests {
    ...
    fn should_decode_use_item_with_target() {
        ...
        let packet = UseItemWithTargetPacket::decode(&mut payload).unwrap();
