...
pub struct CollectRewardChestPacket {
...
impl Decodable for CollectRewardChestPacket {
    const KIND: PacketKind = PacketKind::CollectRewardChest;
...
mod tests {
    ...
    fn should_decode_collect_reward_chest() {
        ...
        let packet = CollectRewardChestPacket::decode(&mut payload)
    ...
    #[test]
    fn should_expose_collect_reward_chest_kind_constant() {
        assert_eq!(
            CollectRewardChestPacket::KIND,
            PacketKind::CollectRewardChest
        );
    }
}
