...
/// # Examples
/// ```
/// use suon_protocol::packets::client::{Decodable, PacketKind, prelude::Target};
///
/// let mut payload: &[u8] = &[0x78, 0x56, 0x34, 0x12];
/// let packet = Target::decode(PacketKind::Target, &mut payload).unwrap();
///
...
mod tests {
    ...
    fn should_decode_target() {
        ...
        let packet = Target::decode(PacketKind::Target, &mut payload)
            .expect("Target packets should decode the target id");
