...
pub struct OpenTransactionHistoryPacket {
    /// Number of entries requested for the first page.
    pub entries_per_page: u8,
}

impl Decodable for OpenTransactionHistoryPacket {
    const KIND: PacketKind = PacketKind::OpenTransactionHistory;
...
mod tests {
    ...
    fn should_decode_open_transaction_history() {
        ...
        let packet = OpenTransactionHistoryPacket::decode(&mut payload)
