...
impl Decodable for RuleViolationReportPacket {
    const KIND: PacketKind = PacketKind::RuleViolationReport;
...
mod tests {
    ...
    fn should_decode_rule_violation_report() {
        ...
        let packet = RuleViolationReportPacket::decode(&mut payload).unwrap();
